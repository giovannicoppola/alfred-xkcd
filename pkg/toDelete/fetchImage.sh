...
# Wrapper script for fetch-image command (equivalent to fetchImage.py)
...
# Call the binary with fetch-image command and pass the comic number
exec "$BINARY" fetch-image "$@"
