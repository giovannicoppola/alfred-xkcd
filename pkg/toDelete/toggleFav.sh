...
# Wrapper script for toggle-fav command (equivalent to toggleFav.py)
...
# Call the binary with toggle-fav command and pass the comic number
exec "$BINARY" toggle-fav "$@"
