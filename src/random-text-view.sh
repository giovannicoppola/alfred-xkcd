...
# Random Text View Script
# This script gets a random unread comic and shows it in text view directly

# Set the Alfred workflow data path if not already set
if [ -z "$alfred_workflow_data" ]; then
    export alfred_workflow_data="/Users/giovanni.coppola/Library/Application Support/Alfred/Workflow Data/giovanni.xkcd"
fi
